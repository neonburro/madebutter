...
// Request a reset. Staff enter their username OR email; we resolve to the email
// server-side, then Supabase emails a recovery link. Big bold clean style.
      ...
      <main className="mx-auto flex min-h-screen w-full max-w-md flex-col justify-center px-6 py-16">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="mt-4 max-w-sm text-base font-semibold leading-relaxed" style={{ color: 'var(--mb-text-secondary)' }}>
            {sent
              ? 'If that account exists, we sent a reset link to its email. Check your inbox.'
        ...
        {!sent && (
          <div className="mt-10 space-y-4">
            <input value={identifier} onChange={(e) => setIdentifier(e.target.value)} onKeyDown={onKey}
              placeholder="username or email" autoCapitalize="none"
