...
// Save closes cleanly. Mobile = bottom sheet; desktop = wide centered rectangle.
      ...
      {item && (
        <>
          ...
          <div className="fixed inset-0 z-[70] flex items-end justify-center sm:items-center sm:p-6" onClick={onClose}>
            <motion.div
              className="max-h-[92vh] w-full max-w-md overflow-y-auto rounded-t-3xl sm:max-h-[88vh] sm:max-w-3xl sm:rounded-3xl"
            ...
            >
              ...
              <div className="sm:flex sm:gap-6 sm:px-6">
                <div className="px-4 sm:w-2/5 sm:px-0">
                  <button
                ...
                <div className="space-y-4 p-4 sm:flex-1 sm:p-0">
              ...
              <div className="sticky bottom-0 border-t p-4 sm:px-6" style={{ background: 'var(--mb-surface-base)', borderColor: 'var(--mb-surface-line)' }}>
